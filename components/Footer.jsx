    ...
    <footer className="bg-neutral-50 border-t border-neutral-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="text-neutral-900 text-xs tracking-widest uppercase font-medium mb-4">Suivez-nous</h4>
            <div className="flex flex-col gap-2">
              <a
                href="https://www.facebook.com/profile.php?id=61585803736939"
                target="_blank"
                rel="noopener noreferrer"
                className="text-neutral-500 hover:text-neutral-900 text-sm transition-colors flex items-center gap-2"
              >
              ...
              <a
                href="https://www.instagram.com/yazi.tn"
                target="_blank"
                rel="noopener noreferrer"
                className="text-neutral-500 hover:text-neutral-900 text-sm transition-colors flex items-center gap-2"
              >
          ...
          <div>
            ...
            <a href="tel:+21693733766" className="text-neutral-500 hover:text-neutral-900 text-sm transition-colors">
              +216 93 733 766
            </a>
          </div>
        </div>
